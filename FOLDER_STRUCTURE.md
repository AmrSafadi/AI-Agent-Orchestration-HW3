...
Contains inspectable agent outputs.

Reason:

- The grader can see the context chain from Planner to LaTeX Agent.
...
| File | Agent |
|---|---|
| `data/intermediate/book_plan.json` | Planner Agent |
| `data/intermediate/research_pack.json` | Research Agent |
| `data/intermediate/manuscript.md` or `.json` | Writer Agent |
| `data/intermediate/review_report.json` | Reviewer Agent |
| `data/intermediate/latex_spec.json` | LaTeX Agent |
