...
| pytest + pytest-cov | Tests + 85% coverage gate; 101 passed, 2 skipped, 93.38% coverage (gate 85%) | Configured & passing |
...
Automated gates replace manual review: 101 tests pass, 2 skip, at 93.38% coverage
