...
| pytest + pytest-cov | Tests + 85% coverage gate; 99 passed, 2 skipped, 93.05% coverage (gate 85%) | Configured & passing |
...
Automated gates replace manual review: 99 tests pass, 2 skip, at 93.05% coverage
