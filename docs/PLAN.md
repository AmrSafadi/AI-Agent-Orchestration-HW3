...
| pytest + pytest-cov | Tests + 85% coverage gate; 89 tests, 92.46% coverage (gate 85%) | Configured & passing |
...
Automated gates replace manual review: 89 tests pass at 92.46% coverage
